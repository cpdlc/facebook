...
const PostCard = ({ post }) => {
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <Card
      style={{borderRadius:"20px",background:"#c6c6c6"}}
        ...
        actions={[
          ...
          id && post.User.id === id
            ...
            : <></>,
            id && post.User.id === id
            ?   <DeleteOutlined type="delete"  loading={removePostLoading} onClick={onRemovePost} />
            : <></>,
      ...
      >
        {post.RetweetId && post.Retweet
          ? (
            ...
            >
              <div style={{ float: 'right' }}>{moment(post.createdAt).startOf('hour').fromNow() }글 
              {moment(post.createdAt).format('YYYY.MM.DD')}&nbsp;&nbsp;</div>
              <Card.Meta
                avatar={(
          ...
          : (
            <>
              <div style={{ float: 'right' }}>{moment(post.createdAt).startOf('hour').fromNow() }글 {moment(post.createdAt).format('YYYY.MM.DD')}&nbsp;&nbsp;</div>
              <Card.Meta
              style={{padding:"10px",background:"#ecfffa", borderRadius:"10px"}}
                avatar={(
